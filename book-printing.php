...
<div class="grid-100 color-logos description-box zero">
	<div class="main-width-constraint-noedge zero">
		...
		<div class="box-066 first">
            ...
            <p>Short run printing allows for more quality checks and better color control during production. Short run printing also opens the door for more customization options, such as binding selections, book sizes, and paper stocks.</p>
            ...
            <p>If you need at least 25 or more books, I encourage you to get a quote using <?php echo WEBSITE_NAME; ?>'s <a href="contact-us.php">Contact Us Form</a>.
...
<div class="grid-100 graywrap description-box zero">
	<div class="main-width-constraint-noedge zero">
        ...
        <div class="box-100 text-center homepage-header">
            ...
            you don't see listed? <a href="contact-us.php">Contact us</a>, and we'll see if we can add it to your
            print order.</p>
        </div>
...
<div class="grid-100 description-box zero">
	<div class="main-width-constraint-noedge zero">
		...
		<div class="box-100 text-center homepage-header">
            ...
            <p>Digital printing remains at the forefront of book printing technology. <?php echo WEBSITE_NAME; ?> utilizes industry-leading
            ...
            all types of paper, including both our coated and uncoated stocks.
            </p>
		</div>
	...
	<div class="main-width-constraint-noedge constraint-extend zero">
        ...
        <div class="grid-100 zero"></div>
            <div class="box-025 homepage-header first">
                <h2 class="font-white">Why Print Your Book with <?php echo WEBSITE_NAME; ?>?</h2>
        ...
        <div class="grid-100 zero text-center">
            <div class="box-033 first valign-bottom">
                <div class="radius-box">
                    ...
                    <p>Working with QureLogix has been simply the best experience for which I could have hoped. It’s my wish that all authors can have
            ...
            <div class="box-033 valign-bottom">
                <div class="radius-box bookshelf-bg">
                   ...
                   <div class="vspace-2em"></div>
                    ...
                    <p class="font-white fontsize-120">Read success stories from independent authors and publishers who have worked with QureLogix
                    Printing.</p>
            ...
            <div class="box-033 last valign-bottom">
                <div class="radius-box">
                    ...
                    <p>This is the third book that <?php echo WEBSITE_NAME; ?> has printed for us. It's of the highest quality and our customers were very impressed. This
