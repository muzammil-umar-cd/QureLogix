  ...
  <script>
      ...
      function baseParams(form) {
          ...
          switch (binding) {
              case 'perfect':
                  binding_name = 'Softcover';
                  break;
              case 'spiral':
                  binding_name = 'Spiral Bound';
                  break;
              case 'hardcover_pl':
                  binding_name = 'Printed Hardcover';
                  break;
              case 'hardcover_foil':
                  binding_name = 'Cloth Bound Hardcover';
                  break;
              case 'hardcover_dj':
                  binding_name = 'Cloth Hardcover with Dustjacket';
                  break;
          }
          ...
          params.push({
              name: 'cover_mat_code',
              value: cover_mat_code
          });
          params.push({
              name: 'cover_mat_code_name',
              value: cover_mat_name
          });
          params.push({
              name: 'orientation',
              value: orientation
